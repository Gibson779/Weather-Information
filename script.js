...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=manchester', options)
	.then(response => response.json())
	.then(response => {

        manchester_temp.innerHTML= response.temp,

        manchester_wind_speed.innerHTML= response.wind_speed,
            // "feels_like": 15,
            manchester_humidity.innerHTML= response.humidity,
            // "min_temp": 16,
            // "max_temp": 16,
            // "wind_degrees": 270,
            // "sunrise": 1671673206,
